...
def add_to_transaction_ids(year: str, week: str, transaction_info: dict,
                           weekly_transaction_ids: List[str], commish_action: bool,
                           use_faab: bool) -> None:
    """
    ...
    Args:
        ...
        weekly_transaction_ids: list of transaciton ids that have been added to the cache
    ...
    if transaction_type in valid_add_or_drop_types:
        ...
        if transaction_type == "add" and use_faab and transaction_info.get("waiver_bid", None) != None:
