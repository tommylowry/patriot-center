...
class TestGetImageUrl:
    ...
    def setup(self):
        ...
        with patch('patriot_center_backend.utils.image_providers.CACHE_MANAGER.get_player_ids_cache') as mock_get_player_ids_cache, \
             patch('patriot_center_backend.utils.image_providers.CACHE_MANAGER.get_players_cache') as mock_get_players_cache, \
             patch('patriot_center_backend.utils.image_providers.get_current_manager_image_url') as mock_get_mgr_url, \
             patch('patriot_center_backend.utils.image_providers.NAME_TO_MANAGER_USERNAME', {"Manager 1": "user1"}):
    ...
    def test_manager_string_url(self):
        ...
        self.mock_get_mgr_url.return_value = "http://sleepercdn.com/avatars/avatar123"
    ...
    def test_unknown_item(self, capsys):
        ...
        assert "Could not find image URL" in captured.out
...
class TestGetCurrentManagerImageUrl:
    ...
    def setup(self):
        """Setup common mocks for all tests."""
        with patch('patriot_center_backend.utils.image_providers.CACHE_MANAGER.get_manager_cache') as mock_get_manager_cache, \
             patch('patriot_center_backend.utils.image_providers.fetch_sleeper_data') as mock_fetch_sleeper:
    ...
    def test_missing_user_id(self):
        ...
        with pytest.raises(ValueError, match="Manager 1 does not have a user_id in "):
