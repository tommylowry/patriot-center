...
class TestFilter:
    ...
    def test_calls_validate_with_all_args(self):
        ...
        self.mock_validate.assert_called_once_with("2024", "1", "Tommy", "QB",
                                                   None)
    ...
    def test_calls_find_valid_weeks_with_filters(self):
        ...
        self.mock_find_weeks.assert_called_once_with("2024", "Tommy", "QB",
                                                     None)
    ...
    def test_locks_position_when_player_provided(self):
        ...
        self.mock_find_years.assert_called_once_with(None, "QB",
                                                     "Jayden Daniels")
    ...
    def test_calls_format_output_with_results(self):
        ...
        self.mock_format.assert_called_once_with({"2024", "2023"}, {"1", "2"},
                                                 {"Tommy", "Anthony"},
                                                 {"QB", "RB"})
    ...
    def test_with_no_filters(self):
        ...
        self.mock_validate.assert_called_once_with(None, None, None, None,
                                                   None)
    ...
    def test_player_position_used_in_all_find_calls(self):
        ...
        self.mock_find_years.assert_called_once_with("Tommy", "QB",
                                                     "Jayden Daniels")
        self.mock_find_weeks.assert_called_once_with("2024", "Tommy", "QB",
                                                     "Jayden Daniels")
        self.mock_find_managers.assert_called_once_with(
