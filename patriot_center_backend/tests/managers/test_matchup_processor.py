...
class TestMatchupProcessorInit:
    ...
    def test_init_stores_init_data(self):
        """Test that __init__ stores cache reference."""
        processor = MatchupProcessor(playoff_week_start=15)
...
class TestSessionState:
    ...
    def test_set_session_state(self, mock_matchup_processor):
    ...
    def test_clear_session_state(self, mock_matchup_processor):
...
class TestScrubMatchupData:
    ...
    def setup(self, mock_manager_cache):
        ...
        with patch('patriot_center_backend.managers.matchup_processor.CACHE_MANAGER.get_manager_cache') as mock_get_manager_cache, \
             patch('patriot_center_backend.managers.matchup_processor.fetch_sleeper_data') as mock_fetch_sleeper_data, \
             patch('patriot_center_backend.managers.matchup_processor.get_season_state') as mock_get_season_state, \
             patch('patriot_center_backend.managers.matchup_processor.MatchupProcessor._add_matchup_details_to_cache') as mock_add_matchup_to_cache, \
             patch('patriot_center_backend.managers.matchup_processor.LEAGUE_IDS', {2023: "mock_league_id"}):
    ...
    def test_scrub_matchup_data_regular_season_win(self, mock_matchup_processor):
        ...
        mock_matchup_processor.scrub_matchup_data("2023", "1")
        ...
        manager_1_call = [call for call in self.mock_add_matchup_to_cache.call_args_list
    ...
    def test_scrub_matchup_data_tie(self, mock_matchup_processor):
    ...
    def test_scrub_matchup_data_filters_playoff_teams(self, mock_matchup_processor):
        ...
        mock_matchup_processor.scrub_matchup_data("2023", "15")
        ...
        managers_called = [call[0][0]["manager"] for call in self.mock_add_matchup_to_cache.call_args_list]
...
class TestAddMatchupDetailsToCache:
    ...
    def test_add_matchup_details_updates_weekly_cache(self, mock_matchup_processor):
        ...
        weekly_data = self.mock_manager_cache["Manager 1"]["years"]["2023"]["weeks"]["1"]["matchup_data"]
    ...
    def test_add_matchup_details_updates_yearly_summary(self, mock_matchup_processor):
        ...
        yearly_overall = self.mock_manager_cache["Manager 1"]["years"]["2023"]["summary"]["matchup_data"]["overall"]
        ...
        yearly_season = self.mock_manager_cache["Manager 1"]["years"]["2023"]["summary"]["matchup_data"]["regular_season"]
        assert yearly_season["wins"]["total"] == 1
        assert yearly_season["points_for"]["total"] == 120.5

    def test_add_matchup_details_updates_top_level_summary(self, mock_matchup_processor):
        ...
        top_overall = self.mock_manager_cache["Manager 1"]["summary"]["matchup_data"]["overall"]
        assert top_overall["wins"]["total"] == 1
        assert top_overall["points_for"]["total"] == 150.0

        # Assert top-level playoff summary was updated
        top_playoffs = self.mock_manager_cache["Manager 1"]["summary"]["matchup_data"]["playoffs"]
        assert top_playoffs["wins"]["total"] == 1
        assert top_playoffs["points_for"]["total"] == 150.0

    def test_add_matchup_details_handles_loss(self, mock_matchup_processor):
    ...
    def test_add_matchup_details_handles_tie(self, mock_matchup_processor):
    ...
    def test_add_matchup_details_raises_on_invalid_data(self, mock_matchup_processor):
        ...
        with pytest.raises(ValueError, match="Invalid matchup data"):
            mock_matchup_processor._add_matchup_details_to_cache(invalid_matchup)
    
    def test_processor_modifies_cache_in_place(self, mock_matchup_processor):
...
class TestScrubPlayoffData:
    ...
    def test_scrub_playoff_data_adds_appearances(self, mock_matchup_processor):
        ...
        assert "2023" in self.mock_manager_cache["Manager 1"]["summary"]["overall_data"]["playoff_appearances"]
        assert "2023" in self.mock_manager_cache["Manager 2"]["summary"]["overall_data"]["playoff_appearances"]

    def test_scrub_playoff_data_skips_duplicates(self, mock_matchup_processor):
        """Test that duplicate playoff appearances are not added."""
        # Pre-populate with existing playoff appearance
        self.mock_manager_cache["Manager 1"]["summary"]["overall_data"]["playoff_appearances"].append("2023")
        ...
        appearances = self.mock_manager_cache["Manager 1"]["summary"]["overall_data"]["playoff_appearances"]
