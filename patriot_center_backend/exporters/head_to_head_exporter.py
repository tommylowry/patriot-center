...
from patriot_center_backend.cache.queries.head_to_head_queries import (
    get_head_to_head_overall,
    list_matchups_between_two_managers,
)
...
def get_head_to_head(
    ...
    return_dict = {
        ...
        "overall": get_head_to_head_overall(manager1, manager2, year=year),
        "matchup_history": list_matchups_between_two_managers(
            manager1, manager2, year=year
        ),
        "trades_between": {
